...
namespace LoopBootCamp
{
    ...
    class Program
    {
            ...
            while (charIsValid)
            {
                switch (characterGivenTF)
                {
                    ...
                    case 'N':
                        ...
                        break;
                    default:
                        Console.WriteLine("Error: invalid entry. Please enter an y or a n");
                        var testerVariable2 = Console.ReadLine();
                        parseSuccess2 = char.TryParse(testerVariable2, out characterGivenTF);
                        if (parseSuccess2)
                        {
        ...
        static void ConvertDecimaltoBinary()
        {
            ...
            n++; ReadAndValidateInputCharYesorNo(ref charGivenYN);
        ...
        static void VariablesMemoryAndDomain()
        {
            ...
            Console.WriteLine("2. ulong \t  B:4 bytes, { 0,...,232 - 1} = { 0...4,294,967,295} ");//a
            ...
            Console.WriteLine("Please pair number 3 with the correct letter by typing the letter in and then hitting enter");
            n++; ReadAndValidateInputCharYesorNo(ref charGivenYN); BisTrue = true; CheckMultipleChoiceQuestions(); BisTrue = false;
        ...
        static void MethodQuestions()
        {
            ...
            Console.WriteLine("True or false: when you call a method that has arguments, you do not need to include data types."); TrueisTrue = true; n++;
